...
public class CompareSorters 
{
	...
	{		
		...
		String fileName;
		int userInput = 0, numPoints, counter = 1;
		...
		System.out.println();
		// All numbers that are not 1 or 2 are treated as 3
	...
	{ 
		...
		//Generates random points between -50 and 50
		for(int i = 0; i < numPts; ++i) {
			randX = rand.nextInt(101) - 50;
			randY = rand.nextInt(101) - 50;
